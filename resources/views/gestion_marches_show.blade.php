    ...
    <div class="container">
        ...
        <table class="market-details-table">
            ...
            <tr>
                ...
                <td>{{ $gestionMarche->montant_marche }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>{{ $gestionMarche->avenant_rib }}</td>
            </tr>
            <tr>
                <th>Banque :</th>
                <td>{{ $gestionMarche->banque }}</td>
            </tr>
            <tr>
                <th>Observations :</th>
                <td>{{ $gestionMarche->observations }}</td>
            </tr>
        </table>
        <a href="{{ route('gestion_marches.index') }}" class="btn">Revenir à la liste des marchés</a>
    </div>
</body>
</html>
@endsection